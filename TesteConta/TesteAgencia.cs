...
namespace ControleContas.Tests
{
    ...
    public class AgenciaTests
    {
        ...
        public void TestarCriacaoAgenciaValida()
        {
            ...
            Agencia agencia = new Agencia(100, "78560-000", "24999999999", banco);

            Assert.AreEqual(100, agencia.Numero);
            Assert.AreEqual("78560-000", agencia.Cep);
        ...
        {
            Banco banco = new Banco("Santander", 1);
            Agencia agencia = new Agencia(0, "78560-000", "24999999999", banco);
        }
        ...
        {
            Banco banco = new Banco("Santander", 1);
            Agencia agencia = new Agencia(100, "78560-000", "", banco);
        }
        ...
        {
            Agencia agencia = new Agencia(100, "78560-000", "24999999999", null);
        }
    }
}